...
var ENTRY_POINT = {
    ...
    js: {
        entry: {
            app: '../pages/authors/app.js'
        }
    },
    css: {
        entry: {
            app: '../assets/styles/pages/authors/authors.scss'
        }
    }
};
...
gulp.task('css-production', function () {
    return gulp.src('../../assets/styles/pages/authors/authors.scss')
        .pipe(sass({outputStyle: 'compressed'}).on('error', sass.logError))
        .pipe(postcss(processorArray))
        .pipe(gulp.dest('../../assets/styles/pages/authors/'));
});
...
gulp.task('authors-dev-css', ['webpack-dev-server-css', 'watch']);
gulp.task('authors-dev-js', ['webpack-dev-server-js', 'watch']);
gulp.task('authors-production', ['js-production', 'css-production']);
